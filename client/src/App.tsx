...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-100 dark:from-gray-900 dark:via-gray-900 dark:to-slate-800 flex flex-col items-center py-10 px-4 sm:px-6 transition-colors duration-500 selection:bg-primary/20">
      <div className="w-full max-w-3xl animate-in fade-in-0 zoom-in-95 duration-500">
        
        <header className="mb-8 text-center relative group cursor-default">
        ...
        <Card className="border-border/60 shadow-2xl backdrop-blur-xl bg-card/80 overflow-hidden relative">
          ...
          <CardContent className="p-6 md:p-8 space-y-8">
            ...
            <section className="relative">
              <Badge variant="outline" className="absolute -top-3 left-0 bg-background rotate-1">Yangi Vazifa</Badge>
              <div className="pt-4">
                 <AddTodo />
              </div>
            </section>
